...
# X_train_final = np.concatenate((Loan_ID_train , X_train_encoded), axis=1)
# X_train_final = np.concatenate((X_train_final, standard_X_train), axis=1)

# Loan_ID_test = X_test[['Loan_ID']].values.reshape(-1, 1)

X_test_final = np.concatenate((X_test_encoded, standard_X_test), axis=1)
# X_test_final = np.concatenate((Loan_ID_test, X_test_encoded), axis=1)
# X_test_final = np.concatenate((X_test_final, standard_X_test), axis=1)
...
print("Training set - Features:", X_train_final.shape, "Targets:", y_train_final.shape)
print("Testing set - Features:", X_test_final.shape, "Targets:", y_test_final.shape)
